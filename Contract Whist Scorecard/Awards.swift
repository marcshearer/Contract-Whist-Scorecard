...
public class Awards {
    ...
    private func setupConfig() {
        self.config = [
            ...
            AwardConfig(code: "weekGames", name: "Busy Bee", shortName: "Busy Bee", title: "Play %d games in a week",
                   awardLevels: [10, 15, 20],
                   compare: .equal, custom: gamesInWeek,
                   imageName: "award week games %d"),
            AwardConfig(code: "dayGames3", name: "Keen Bean", shortName: "Keen Bean", title: "Play %d games in a day",
                   awardLevels: [3],
                   compare: .equal, custom: gamesInDay,
                   imageName: "award day games %d"),
            AwardConfig(code: "dayGames4", name: "Fore!", shortName: "Fore!", title: "Play %d games in a day",
                   awardLevels: [4],
                   compare: .equal, custom: gamesInDay,
                   imageName: "award day games %d"),
            ...
            AwardConfig(code: "lowWin", name: "Win Low Score", shortName: "Low Win", title: "Win the game with %d points or less",
                   awardLevels: [100, 90, 80],
                   compare: .lessOrEqual, source: .current, key: "totalScore", winLose: .win,
                   imageName: "award low win %d"),
            AwardConfig(code: "highLoss", name: "Close, but no Banana", shortName: "Big Loser", title: "Score more than %d points but still lose the game",
                   awardLevels: [130],
            ...
            AwardConfig(code: "awards", name: "VIP", shortName: "VIP", title: "This award is for being awarded %d awards",
                   awardLevels: [25], repeatable: false,
                   compare: .greaterOrEqual, source: .awards, key: "",
                   imageName: "awards %d"),
            AwardConfig(code: "awards", name: "VIP", shortName: "VIP", title: "This award is for being awarded %d awards",
                   awardLevels: [50], repeatable: false,
                   compare: .greaterOrEqual, source: .awards, key: "",
                   imageName: "awards %d"),
        ]
    }
