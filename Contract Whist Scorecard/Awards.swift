    ...
    private func setupConfig() {
        self.config = [
            ...
            AwardConfig(code: "twosGame", name: "Game Twos", shortName: "Game Twos", title: "%d twos made in one game",
                   ...
                   condition: { Scorecard.settings.bonus2 }),
            AwardConfig(code: "winStreak", name: "Don't Stop Me Now", shortName: "Streak", title: "%d wins in a row",
            ...
            AwardConfig(code: "dayGames3", name: "Rule of Three", shortName: "Rule of 3", title: "%d games in a day",
                   awardLevels: [3],
                   compare: .equal, custom: gamesInDay,
                   imageName: "award day games %d"),
            AwardConfig(code: "dayGames4", name: "Day Games", shortName: "Day", title: "%d games in a day",
                   awardLevels: [4],
                   compare: .equal, custom: gamesInDay,
                   imageName: "award day games %d"),
            AwardConfig(code: "dayGames", name: "Get Your 5 a Day", shortName: "5 a Day", title: "%d games in a day",
                   awardLevels: [5],
                   compare: .equal, custom: gamesInDay,
                   imageName: "award day games %d"),
            ...
            AwardConfig(code: "totalScore", name: "Flying High", shortName: "Flying High", title: "Scored over %d in the game",
