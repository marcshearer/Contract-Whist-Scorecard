    ...
    static func sendPlayerUUID(from: UIViewController) {
        ...
        if MFMailComposeViewController.canSendMail() {
            ...
            for playerMO in Scorecard.shared.playerList {
                ...
                bodyText = bodyText + ", \(playerMO.winStreak)"
                ...
                bodyText = bodyText + ", \(playerMO.maxWinStreak)"
                bodyText = bodyText + ", \(playerMO.maxWinStreakDate == nil ? "\"\"" : Utility.dateString(playerMO.maxWinStreakDate! as Date))"
