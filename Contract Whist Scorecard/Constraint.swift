...
class Constraint {
    ...
    public static func setWidth(control: UIView, width: CGFloat, priority: UILayoutPriority = .required) -> NSLayoutConstraint {
    ...
    public static func setHeight(control: UIView, height: CGFloat, priority: UILayoutPriority = .required) -> NSLayoutConstraint {
    ...
    public static func anchor(view: UIView, control: UIView, to: UIView? = nil, multiplier: CGFloat = 1.0, constant: CGFloat = 0.0, toAttribute: NSLayoutConstraint.Attribute? = nil, priority: UILayoutPriority = .required, attributes: NSLayoutConstraint.Attribute...) {
    ...
    public static func proportionalWidth(view: UIView, control: UIView, to: UIView? = nil, multiplier: CGFloat = 1.0, priority: UILayoutPriority = .required) {
        let to = to ?? view
    ...
    public static func proportionalHeight(view: UIView, control: UIView, to: UIView? = nil, multiplier: CGFloat = 1.0, priority: UILayoutPriority = .required) {
        let to = to ?? view
