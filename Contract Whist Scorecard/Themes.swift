...
class Themes {
    ...
    static let themes: [String : Theme] = [
        "Default" : Theme(descriptino: "Default colour theme", color: [
                            ...
                            .total                       : (#colorLiteral(red: 0.936478436, green: 0.8771598935, blue: 0.7069370747, alpha: 1), nil) ,
                            .totalText                   : (#colorLiteral(red: 0.4979934692, green: 0.4980684519, blue: 0.4979770184, alpha: 1), nil) ,
