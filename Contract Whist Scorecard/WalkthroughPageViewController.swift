    ...
    var details: [(title: String, image: String, tabletImage: String, compact: String, verbose: String)] =
                        [("Get Started", "get started screen", "",
                         ...
                         ("Welcome", "welcome screen", "welcome ipad screen",
                          "The welcome screen gives you access to settings, statistics, history and high scores. Click 'New Game' to start playing. If you re-start the app, click 'Resume Game' to continue a game in progress",
                          ""),
                        ("Settings", "settings screen", "",
                            ...
                            "Settings change the behaviour of the app. You can choose how (if at all) the dealer is highlighted on the scorecard. You can switch on a special rule where you get a bonus of 10 points if you win a trick with a two. You can choose between the dealer starting the bidding or the next player. You can choose how many hands to play in a game. You can choose if stats can  be shared between devices over iCloud. The player's unique identifier field is used to link players across devices. These could for example be email addresses or any other unique identifiers that are consistent across devices"),
                        ("Player Stats", "stats screen", "stats ipad screen",
                            "Player stats show you a summary of each player. Tap a player for more detail or click 'Select' to choose several players to compare. You can also sync with iCloud using the 🔄 button",
                            "Player stats show you a summary of each player. Tap a player for more detail or click 'Select' to choose several players to compare. You can also sync with iCloud using the 🔄 button if you have enabled synchronisation in settings. You also need to be logged into iCloud on your device"),
                        ("Player Comparison", "comparison screen", "comparison ipad screen",
                            "Player comparison shows detailed stats for the players you have selected. Tap a player to see more detail. Tap a column header to sort by that value. Tap twice to reverse sort. You can also sync with iCloud using the 🔄 button",
                            "Player comparison shows detailed stats for the players you have selected. Tap a player to see more detail. Tap a column header to sort by that value. Tap twice to reverse sort. You can also sync with iCloud using the 🔄 button if you have enabled synchronisation in settings"),
                        ("Player Detail", "player detail screen", "",
                            "Amend the player's name and unique ID or click the camera to add a photo for them. You can amend / remove an existing photo by tapping it. Also you can see all their stats",
                            "Amend the player's name and unique ID or click the camera to add a photo for them. You can amend / remove an existing photo by tapping it. Also you can see all their stats. You can delete a player by pressing the 'Delete' button"),
